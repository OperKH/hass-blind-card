        ...
        .sc-blinds { padding: 16px; }
          ...
          .sc-blind-middle { display: flex; max-width: 210px; width: 100%; margin: auto; }
            ...
            .sc-blind-selector { flex: 1; }
              .sc-blind-selector-picture { position: relative; margin: auto; background-size: 100% 100%; background-repeat: no-repeat; min-height: 150px; max-height: 100%; width: 100%; max-width: 153px; }
